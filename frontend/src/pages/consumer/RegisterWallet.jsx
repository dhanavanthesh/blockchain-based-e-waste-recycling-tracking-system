        ...
        <Paper elevation={2} sx={{ p: 4 }}>
          <Box textAlign="center" mb={4}>
            ...
            <Typography variant="body2" color="text.secondary">
              Register as a Consumer to view device history and track ownership
            </Typography>
          </Box>
          ...
          {isConnected && !isRegistered && activeStep === 1 && (
            <Box textAlign="center" py={4}>
              ...
              <Typography variant="body2" color="text.secondary" mb={3}>
                Register your wallet address on the blockchain as a Consumer
              </Typography>
              <Button
                variant="contained"
                size="large"
...
export default ConsumerRegisterWallet;
